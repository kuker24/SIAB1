...
RUNTIME="$ROOT/runtime_control/nginx.answer-canary.conf"
OFF="$ROOT/docker/nginx.answer-canary-off.conf"
...
mode_file() {
  ...
  printf "%s\n" "$ROOT/docker/nginx.answer-canary-${name}.conf"
}
