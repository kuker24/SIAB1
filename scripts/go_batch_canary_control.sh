...
RUNTIME="$ROOT/runtime_control/nginx.batch-canary.conf"
OFF="$ROOT/docker/nginx.batch-canary-off.conf"
...
mode_file() {
  ...
  printf "%s\n" "$ROOT/docker/nginx.batch-canary-${name}.conf"
}
