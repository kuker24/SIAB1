...
RUNTIME="$ROOT/runtime_control/nginx.autosave-canary.conf"
OFF="$ROOT/docker/nginx.autosave-canary-off.conf"
...
mode_file() {
  ...
  printf "%s\n" "$ROOT/docker/nginx.autosave-canary-${name}.conf"
}
