...
RUNTIME="$ROOT/runtime_control/nginx.join-canary.conf"
OFF="$ROOT/docker/nginx.join-canary-off.conf"
...
mode_file() {
  ...
  printf "%s\n" "$ROOT/docker/nginx.join-canary-${name}.conf"
}
